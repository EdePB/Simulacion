...
##############################guardamos cada posicion de cada particula inicialmente
...
colnames(datos)=c("distancia","velocidad", "masa")

ggplot()+
  geom_point(data = datos, aes(x= datos$masa, y= datos$velocidad))+
  geom_line()
  ggtitle("masa vs velocidad")+
  theme(plot.title = element_text(hjust = 0.5))
